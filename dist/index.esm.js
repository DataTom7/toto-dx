...
const TotoLogo = ({ size = 48, color = '#FDB813', className = '', alt = 'Toto Logo', }) => {
    return (jsx("span", { className: cn('font-raleway font-extrabold leading-none tracking-[-0.02em] lowercase', className), style: {
            fontSize: size,
            color: color,
...
const Button = React.forwardRef(({ className, variant, size, asChild = false, loading = false, loadingText, children, disabled, ...props }, ref) => {
    ...
    return (jsxs(Comp, { className: cn(buttonVariants({ variant, size, className })), ref: ref, disabled: disabled || loading, ...props, children: [loading && (jsxs("svg", { className: "animate-spin -ml-1 mr-2 h-4 w-4", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", "aria-hidden": "true", children: [jsx("circle", { className: "opacity-25", cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), jsx("path", { className: "opacity-75", fill: "currentColor", d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" })] })), loading ? (loadingText || 'Loading...') : children] }));
});
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (jsx("h3", { ref: ref, className: cn('text-lg font-semibold leading-none tracking-tight', className), ...props })));
...
const Input = React__default.forwardRef(({ className, variant = 'default', size = 'md', error, success, disabled, helperText, errorMessage, label, id, ...props }, ref) => {
    const inputId = id || `input-${Math.random().toString(36).substr(2, 9)}`;
    const hasError = error || !!errorMessage;
    const displayText = hasError ? errorMessage : helperText;
    return (jsxs("div", { className: "w-full", children: [label && (jsx("label", { htmlFor: inputId, className: "block text-sm font-medium text-foreground mb-1", children: label })), jsx("input", { id: inputId, className: cn(
                // Base styles
                ...
                }, className), ref: ref, disabled: disabled, ...props }), displayText && (jsx("p", { className: cn('mt-1 text-xs', hasError ? 'text-destructive' : 'text-muted-foreground'), children: displayText }))] }));
});
Input.displayName = 'Input';

const Badge = React__default.forwardRef(({ className, variant = 'default', size = 'md', dismissible = false, onDismiss, children, ...props }, ref) => {
    const [isDismissed, setIsDismissed] = React__default.useState(false);
    const handleDismiss = () => {
        setIsDismissed(true);
    ...
    return (jsxs("div", { ref: ref, className: cn(
        ...
        }, className), ...props, children: [children, dismissible && (jsx("button", { onClick: handleDismiss, className: "ml-1 inline-flex items-center justify-center rounded-full hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-colors duration-150", "aria-label": "Dismiss", children: jsx("svg", { className: "h-3 w-3", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) }))] }));
});
Badge.displayName = 'Badge';

const Label = React__default.forwardRef(({ className, variant = 'default', size = 'md', children, ...props }, ref) => {
    return (jsx("label", { ref: ref, className: cn(
        // Base styles
...
const Textarea = React__default.forwardRef(({ className, variant = 'default', size = 'md', error, success, disabled, resize = 'vertical', helperText, errorMessage, label, showCharacterCount = false, maxLength, id, value, ...props }, ref) => {
    const textareaId = id || `textarea-${Math.random().toString(36).substr(2, 9)}`;
    const hasError = error || !!errorMessage;
    const displayText = hasError ? errorMessage : helperText;
    const currentLength = typeof value === 'string' ? value.length : 0;
    const isNearLimit = maxLength && currentLength > maxLength * 0.8;
    return (jsxs("div", { className: "w-full", children: [label && (jsx("label", { htmlFor: textareaId, className: "block text-sm font-medium text-foreground mb-1", children: label })), jsx("textarea", { id: textareaId, className: cn(
                // Base styles
                ...
                // States
                {
                    ...
                    'border-green-500 focus-visible:ring-green-500': success,
                    'opacity-50 cursor-not-allowed': disabled,
                }, className), ref: ref, disabled: disabled, value: value, maxLength: maxLength, ...props }), (displayText || showCharacterCount) && (jsxs("div", { className: "flex justify-between items-center mt-1", children: [displayText && (jsx("p", { className: cn('text-xs', hasError ? 'text-destructive' : 'text-muted-foreground'), children: displayText })), showCharacterCount && maxLength && (jsxs("p", { className: cn('text-xs', isNearLimit ? 'text-warning' : 'text-muted-foreground'), children: [currentLength, "/", maxLength] }))] }))] }));
});
...
const Dialog = ({ open = false, onOpenChange, children, className, ...props }) => {
    ...
    if (!isVisible)
        return null;
    return (jsxs("div", { className: cn('fixed inset-0 z-50 flex items-center justify-center', className), ...props, children: [jsx("div", { className: cn('fixed inset-0 bg-black/50 backdrop-blur-sm transition-opacity duration-200', isAnimating ? 'opacity-100' : 'opacity-0'), onClick: () => onOpenChange?.(false) }), children] }));
};
// Dialog Content
const DialogContent = React__default.forwardRef(({ className, variant = 'default', size = 'md', children, ...props }, ref) => {
    const [isAnimating, setIsAnimating] = React__default.useState(false);
    React__default.useEffect(() => {
        setIsAnimating(true);
    }, []);
    return (jsx("div", { ref: ref, className: cn('relative bg-background border border-border rounded-lg shadow-lg transition-all duration-200', 
        // Variants
        {
...
// Dialog Header
const DialogHeader = React__default.forwardRef(({ className, ...props }, ref) => (jsx("div", { ref: ref, className: cn('flex flex-col space-y-1.5 p-6 pb-4', className), ...props })));
DialogHeader.displayName = 'DialogHeader';
// Dialog Title
const DialogTitle = React__default.forwardRef(({ className, ...props }, ref) => (jsx("h2", { ref: ref, className: cn('text-lg font-semibold leading-none tracking-tight', className), ...props })));
DialogTitle.displayName = 'DialogTitle';
// Dialog Description
const DialogDescription = React__default.forwardRef(({ className, ...props }, ref) => (jsx("p", { ref: ref, className: cn('text-sm text-muted-foreground', className), ...props })));
DialogDescription.displayName = 'DialogDescription';
// Dialog Footer
const DialogFooter = React__default.forwardRef(({ className, ...props }, ref) => (jsx("div", { ref: ref, className: cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-6 pt-4', className), ...props })));
DialogFooter.displayName = 'DialogFooter';

// Alert Root
const Alert = React__default.forwardRef(({ className, variant = 'default', size = 'md', dismissible = false, onDismiss, children, ...props }, ref) => {
    const [isDismissed, setIsDismissed] = React__default.useState(false);
    const handleDismiss = () => {
        setIsDismissed(true);
        setTimeout(() => onDismiss?.(), 200); // Allow animation to complete
    ...
    return (jsxs("div", { ref: ref, role: "alert", className: cn(
        // Base styles
        ...
        }, className), ...props, children: [children, dismissible && (jsx("button", { onClick: handleDismiss, className: "absolute top-2 right-2 inline-flex items-center justify-center rounded-full hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 transition-colors duration-150", "aria-label": "Dismiss alert", children: jsx("svg", { className: "h-4 w-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) }) }))] }));
});
Alert.displayName = 'Alert';
// Alert Title
const AlertTitle = React__default.forwardRef(({ className, ...props }, ref) => (jsx("h5", { ref: ref, className: cn('mb-1 font-medium leading-none tracking-tight', className), ...props })));
AlertTitle.displayName = 'AlertTitle';
// Alert Description
const AlertDescription = React__default.forwardRef(({ className, ...props }, ref) => (jsx("div", { ref: ref, className: cn('text-sm [&_p]:leading-relaxed', className), ...props })));
AlertDescription.displayName = 'AlertDescription';

// Avatar Root
const Avatar = React__default.forwardRef(({ className, size = 'md', variant = 'circle', src, alt, fallback, bgColor, ...props }, ref) => {
    const [imageError, setImageError] = React__default.useState(false);
    const [imageLoaded, setImageLoaded] = React__default.useState(false);
    ...
    return (jsxs("div", { ref: ref, className: cn(
        ...
        // Sizes
        {
            ...
            'h-12 w-12': size === 'lg',
            'h-16 w-16': size === 'xl',
        }, className), ...props, children: [src && !imageError && (jsx(AvatarImage, { src: src, alt: alt, onError: handleImageError, onLoad: handleImageLoad })), showFallback && fallback && (jsx(AvatarFallback, { variant: variant, bgColor: bgColor, children: fallback }))] }));
});
Avatar.displayName = 'Avatar';
// Avatar Image
const AvatarImage = React__default.forwardRef(({ className, ...props }, ref) => (jsx("img", { ref: ref, className: cn('aspect-square h-full w-full object-cover', className), ...props })));
AvatarImage.displayName = 'AvatarImage';
// Avatar Fallback
const AvatarFallback = React__default.forwardRef(({ className, children, variant = 'circle', bgColor, ...props }, ref) => (jsx("div", { ref: ref, className: cn('flex h-full w-full items-center justify-center text-muted-foreground font-medium', 
    // Variants
    {
        'rounded-full': variant === 'circle',
        'rounded-none': variant === 'square',
...
const Progress = React__default.forwardRef(({ className, value = 0, variant = 'default', size = 'md', showValue = false, label, indeterminate = false, ...props }, ref) => {
    const clampedValue = Math.min(Math.max(value, 0), 100);
    return (jsxs("div", { className: cn('w-full', className), ...props, children: [(label || showValue) && (jsxs("div", { className: "flex justify-between items-center mb-2", children: [label && (jsx("span", { className: "text-sm font-medium text-foreground", children: label })), showValue && !indeterminate && (jsxs("span", { className: "text-sm text-muted-foreground", children: [Math.round(clampedValue), "%"] }))] })), jsx("div", { ref: ref, className: cn(
                // Base styles
...
// Select Root
const Select = React__default.forwardRef(({ className, variant = 'default', size = 'md', error, success, disabled, placeholder, helperText, errorMessage, label, id, children, ...props }, ref) => {
    const selectId = id || `select-${Math.random().toString(36).substr(2, 9)}`;
    const hasError = error || !!errorMessage;
    const displayText = hasError ? errorMessage : helperText;
    return (jsxs("div", { className: "w-full", children: [label && (jsx("label", { htmlFor: selectId, className: "block text-sm font-medium text-foreground mb-1", children: label })), jsxs("select", { id: selectId, className: cn(
                // Base styles
                ...
                // States
                {
                    ...
                    'opacity-50 cursor-not-allowed': disabled,
                }, className), ref: ref, disabled: disabled, ...props, children: [placeholder && (jsx("option", { value: "", disabled: true, children: placeholder })), children] }), displayText && (jsx("p", { className: cn('mt-1 text-xs', hasError ? 'text-destructive' : 'text-muted-foreground'), children: displayText }))] }));
});
Select.displayName = 'Select';
// Select Option
const SelectOption = React__default.forwardRef(({ className, value, children, ...props }, ref) => (jsx("option", { ref: ref, className: cn('text-foreground', className), value: value, ...props, children: children })));
SelectOption.displayName = 'SelectOption';
// Select Group
const SelectGroup = React__default.forwardRef(({ className, label, children, ...props }, ref) => (jsx("optgroup", { ref: ref, className: cn('text-muted-foreground', className), label: label, ...props, children: children })));
SelectGroup.displayName = 'SelectGroup';

const Separator = React__default.forwardRef(({ className, orientation = 'horizontal', variant = 'default', color = 'default', ...props }, ref) => {
...
const Switch = React__default.forwardRef(({ className, size = 'md', variant = 'default', disabled = false, label, description, id, checked, defaultChecked, ...props }, ref) => {
    const switchId = id || `switch-${Math.random().toString(36).substr(2, 9)}`;
    const [isChecked, setIsChecked] = React__default.useState(checked ?? defaultChecked ?? false);
    ...
    return (jsxs("div", { className: "flex items-center space-x-3", children: [jsxs("div", { className: "relative", children: [jsx("input", { ref: ref, type: "checkbox", id: switchId, className: "sr-only", disabled: disabled, checked: checked, defaultChecked: defaultChecked, onChange: handleChange, ...props }), jsx("label", { htmlFor: switchId, className: cn(
                        // Base styles
                        ...
                        // Disabled state
                        disabled && 'opacity-50 cursor-not-allowed', className), children: jsx("span", { className: cn(
                            // Base styles
                            ...
                            }) }) })] }), (label || description) && (jsxs("div", { className: "flex flex-col", children: [label && (jsx("label", { htmlFor: switchId, className: cn('text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70', disabled && 'opacity-50'), children: label })), description && (jsx("p", { className: cn('text-xs text-muted-foreground mt-1', disabled && 'opacity-50'), children: description }))] }))] }));
});
Switch.displayName = 'Switch';

// Tabs Root
const Tabs = React__default.forwardRef(({ className, defaultValue, value, onValueChange, orientation = 'horizontal', variant = 'default', children, ...props }, ref) => {
    const [activeTab, setActiveTab] = React__default.useState(value || defaultValue || '');
    ...
    return (jsx("div", { ref: ref, className: cn('w-full', orientation === 'vertical' && 'flex', className), ...props, children: React__default.Children.map(children, (child) => {
...
// Tabs List
const TabsList = React__default.forwardRef(({ className, variant = 'default', orientation = 'horizontal', ...props }, ref) => {
    return (jsx("div", { ref: ref, className: cn(
        // Base styles
...
// Tabs Trigger
const TabsTrigger = React__default.forwardRef(({ className, value, variant = 'default', orientation = 'horizontal', activeTab, onTabChange, onClick, ...props }, ref) => {
...
// Tabs Content
const TabsContent = React__default.forwardRef(({ className, value, activeTab, children, ...props }, ref) => {
    const isActive = activeTab === value;
    return (jsx("div", { ref: ref, className: cn('mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all duration-200', isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2 pointer-events-none absolute', className), ...props, children: children }));
});
