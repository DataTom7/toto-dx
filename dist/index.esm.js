...
const TotoLogo = ({ size = 48, color = '#FDB813', className = '', variant = 'default', alt = 'Toto Logo', }) => {
    if (variant === 'text') {
        return (jsx("span", { className: cn('font-extrabold tracking-tight', className), style: {
    ...
    if (variant === 'minimal') {
        return (jsx("div", { className: cn('flex items-center justify-center', className), style: { width: size, height: size }, role: "img", "aria-label": alt, children: jsxs("svg", { width: size, height: size, viewBox: "0 0 100 100", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("circle", { cx: "50", cy: "30", r: "8", fill: color }), jsx("circle", { cx: "35", cy: "45", r: "8", fill: color }), jsx("circle", { cx: "65", cy: "45", r: "8", fill: color }), jsx("circle", { cx: "50", cy: "60", r: "8", fill: color }), jsx("circle", { cx: "35", cy: "75", r: "8", fill: color }), jsx("circle", { cx: "65", cy: "75", r: "8", fill: color })] }) }));
    }
    return (jsx("div", { className: cn('flex items-center justify-center', className), style: { width: size, height: size }, role: "img", "aria-label": alt, children: jsxs("svg", { width: size, height: size, viewBox: "0 0 100 100", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [jsx("circle", { cx: "50", cy: "30", r: "8", fill: color }), jsx("circle", { cx: "35", cy: "45", r: "8", fill: color }), jsx("circle", { cx: "65", cy: "45", r: "8", fill: color }), jsx("circle", { cx: "50", cy: "60", r: "8", fill: color }), jsx("circle", { cx: "35", cy: "75", r: "8", fill: color }), jsx("circle", { cx: "65", cy: "75", r: "8", fill: color }), jsx("ellipse", { cx: "50", cy: "50", rx: "25", ry: "8", fill: color, opacity: "0.3" }), jsx("ellipse", { cx: "50", cy: "50", rx: "15", ry: "4", fill: color, opacity: "0.5" })] }) }));
};
